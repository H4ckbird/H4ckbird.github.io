function botui_init() {
    ...
    var sure = function() {
      ...
      secondpart = function() {
        botui.message.add({
          delay: 5000,
          content: "首先呢，很感谢您肯在这里驻足片刻❤️。H4ck糖果屋是一个个人性质的博客，我会在这里发表各种各样的内容。"
        }).then(function() {
          botui.message.add({
            delay: 15000,
      ...
      thirdpart = function() {
        botui.message.add({
          delay: 1e3,
          content: "诶？Akpigs是我的英文名啊😏，糖果屋，emm🤔，大概是因为我在现实中也很想开一家糖果屋吧。"
        }).then(function() {
          botui.action.button({
            delay: 1500,
            action: [{
              text: "😲，那英文名为什么叫H4ckbird呢？",
              value: "why-cat"
            }]
          }).then(function(a) {
            fourthpart()
